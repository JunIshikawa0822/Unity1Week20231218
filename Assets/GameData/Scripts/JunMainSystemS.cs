...
public class JunMainSystemS : MonoBehaviour
{
    ...
    private void Awake()
    {
        ...
        attackAdmin.DMManager.PenetrateIntervalInit(0.03f);
    ...
    void Update()
    {
        ...
        switch (gamePhase)
        {
            ...
            case 1:
                ...
                HPManager.PlayerHPCheck(Player, 2, enemyLayer,PlayerAnimator);
    ...
    void MissileProcess(List<Enemy> MIList, int number)
    {
